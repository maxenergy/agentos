...
| G004 | done | G002 | medium | Wire REPL development/research dispatch through normal routing. |
...
| G007 | done | G005 | medium | Complete learned Capability Declaration validation and reload for `learn_skill`. |
| G008 | done | G005 | medium | Replace route-hints TSV direction with Capability Declaration Route Hint coverage. |
| G009 | done | G006 | high | Normalize Plugin protocol output before PluginSkillInvoker mapping. |
| G010 | done | G009 | medium | Clarify Plugin Session process-pool policy and admin scope. |
...
| G013 | done | G011 | medium | Harden Audit History recovery tests and document lossy reconstruction. |
| G014 | done | none | medium | Extract Auth Login Flow mode modules from provider adapters. |
| G015 | done | G014 | medium | Define Auth Profile selection across login modes. |
| G016 | blocked | external provider | low | Track Anthropic PKCE defaults and promote only when stable endpoints exist. |
| G017 | done | none | low | Keep domain language and architecture docs synchronized during goals. |
